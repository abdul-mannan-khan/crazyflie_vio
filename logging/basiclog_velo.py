...
class LoggingExample:
    ...
    def _connected(self, link_uri):
        ...
        self._lg_stab1 = LogConfig(name='Stabilizer', period_in_ms=100)
        ...
        self._lg_stab1.add_variable('stateEstimate.vz', 'float')
        ...
        self._lg_stab1.add_variable('pm.vbat', 'FP16')
        ...
        try:
            ...
            self._lg_stab1.data_received_cb.add_callback(self._stab_log_data)
            self._lg_stab.data_received_cb.add_callback(self._stab_log_data)
            
            # This callback will be called on errors
            self._lg_stab1.error_cb.add_callback(self._stab_log_error)
